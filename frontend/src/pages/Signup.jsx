...
import { Activity, Mail, Lock, User, Eye, EyeOff, ArrowRight, Loader2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-dark-950">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-40 -right-40 w-96 h-96 bg-primary-600/5 rounded-full blur-3xl" />
      </div>
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-dark-400 text-sm">Start your emotional wellness journey</p>
        </div>

        {/* Card */}
        <div className="card p-8">
          <h2 className="text-xl font-bold text-white mb-1">Create account</h2>
          <p className="text-dark-400 text-sm mb-6">Sign up to start tracking your emotions</p>
